...
public static class SourceCodeBuilderExtensions
{
    ...
    public static ICodeBlock ConsoleWriteSeveralLines(this ICodeBlock w, List<string> items)
    {
    ...
    public static ICodeBlock InitializeNewList(this ICodeBlock w, List<string> list, Action<IWriter> variableAction)
    {
        w.WriteLine(w =>
        {
    ...
    public static ICodeBlock InitializeNewList(this ICodeBlock w, List<string> list, string variableName)
    {
        return w.InitializeNewList(list, w =>
        {
            w.Write(variableName);
        });
    }
    public static ICodeBlock InitializeNewList(this ICodeBlock w, List<int> list, Action<IWriter> variableAction)
    {
        w.WriteLine(w =>
        {
    ...
    public static ICodeBlock InitializeNewList(this ICodeBlock w, List<int> list, string variableName)
    {
        return w.InitializeNewList(list, w =>
        {
            w.Write(variableName);
    ...
    public static void InitializeFromList<T>(this ICodeBlock w, List<T> list, Action<IWriter, T> action)
    {
        int count = list.Count;
        for (int i = 0; i < list.Count; i++)
        {
    ...
    public static void InitializeFromList<T>(this IWriter w, List<T> list, Action<IWriter, T> action)
    {
